...
<div class="container">
    <div class="alert alert-dismissable alert-warning">
        ...
        <h4>Warning!</h4>
        <p>Please Review the information below before clicking the delete button <a   class="btn " href="confirm_delete.php?id=<?php echo $screen->id; ?>">DELETE</a>.</p>
    </div>
    <div id="screens">
            ...
            <div class="bs-docs-section">
                <div class="row" id='screens-img'>
                    <div class="col-lg-4">
                        ...
                        echo "<div class= 'col-lg-4' > <div class='panel panel-info'>
                ...
                <div class='panel-body'>";
                        ...
                        <a  class="btn" href="./../../views/admin/edit_exp.php">Back</a>
